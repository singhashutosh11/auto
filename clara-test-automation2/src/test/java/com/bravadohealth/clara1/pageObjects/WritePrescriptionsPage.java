...
public class WritePrescriptionsPage extends AbstractPage implements PrescriptionLocators, MedicalHistoryLocators,
DemographicLocators, EditModalLocators, ConfirmationModalLocators, LoaderLocators {
	...
	public WritePrescriptionsPage(WebOperation webOp, PageDataProvider dataProvider) {
	...
	public WritePrescriptionsPage addPrescriptions() throws Exception {
	...
	public WritePrescriptionsPage addAlternatePrescriptions() throws Exception {
		webOp.waitTillAllCallsDoneUsingJS();
...
*/		}
	...
	public WritePrescriptionsPage editPrescriptions() throws Exception {
	...
	public WritePrescriptionsPage checkPediatricAndUpdateWeight() throws Exception {
	...
	public WritePrescriptionsPage openModalWindow() throws Exception {
	...
	public WritePrescriptionsPage modifyPatientProfile() throws Exception {
		PatientDetails editFullPatientData = getEditFullPatientData();
		editPatientProfile(editFullPatientData);
		return this;
	}

	public WritePrescriptionsPage editPatientProfile(PatientDetails editFullPatientData) throws Exception {
	...
	public WritePrescriptionsPage modifyMedicalHistory() throws Exception {
		PatientDetails editFullPatientData = getEditFullPatientData();
		MedicalHistory medicalHistory = editFullPatientData.getMedicalHistory();
		return addEditMedicalHistory(medicalHistory);
	}

	public WritePrescriptionsPage modifyManageMedicalHistory() throws Exception {
	...
	public WritePrescriptionsPage addEditMedicalHistory(MedicalHistory medicalHistory) throws Exception {
	...
	public WritePrescriptionsPage handleInteracnAlerts() throws InterruptedException {
		PatientDetails editFullPatientData = getEditFullPatientData();
	...
	public WritePrescriptionsPage saveChanges() throws Exception {
		PatientDetails editFullPatientData = getEditFullPatientData();
		saveOrDiscardData(editFullPatientData);
		return this;
	}

	public WritePrescriptionsPage saveManagePatientModification() throws InterruptedException {
		ManageExistingPatient manageExistingPatient = dataProvider.getPageData("manageExistingPatient");
		PatientDetails editDetails = manageExistingPatient.getEditDetails();
	...
	public WritePrescriptionsPage moveToPrescriptionPageInMockProject() throws Exception {
