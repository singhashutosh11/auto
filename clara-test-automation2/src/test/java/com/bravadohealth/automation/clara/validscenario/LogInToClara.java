...
public class LogInToClara extends AbstractSeleniumTest {

	private static final String NEGETIVE_SCENARIO_CHECK = "negetiveScenarioCheck";
	private static final String YES = "Yes";
	private static final String CONFIG_FILE = "/clara_scenarios/clara_user_security/login_scenario.xls";
	...
	public String getExcelPath() {
		...
		try {
			return URLDecoder.decode(f.getAbsolutePath() , "UTF-8")+ ";logIn";
	...
	protected void executeTest() throws Exception {
		...
		if (!YES.equals(getParameter(NEGETIVE_SCENARIO_CHECK))) {
			new ClaraLogInPage(this, pdp).logIn();
			//new AuditLogPage(this, pdp).searchLog();//viewRecentActivityLog();
		} else {
			new ClaraLogInPage(this, pdp).InvalidlogIn();
		}
	}
